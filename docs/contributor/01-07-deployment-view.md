...
│  │  Service:     controller-manager-metrics-service (port 8080) │    │
│  │  ServiceMonitor: controller-manager-metrics-monitor          │    │
│  │  NetworkPolicy: allow-egress-to-apiserver                    │    │
│  │  NetworkPolicy: allow-ingress-webhook-traffic                │    │
│  │  NetworkPolicy: allow-ingress-metrics-traffic                │    │
│  │                                                              │    │
│  └──────────────────────────────────────────────────────────────┘    │
│                                                                      │
│  ┌──────────────────────────────┐   ┌──────────────────────────┐     │
