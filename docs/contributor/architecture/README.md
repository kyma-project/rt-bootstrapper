# Architectural Documentation of Runtime Bootstrapper
...
- [Architectural Decisions](appendix/architectural-decisions.md)
- [Resource Synchronization](appendix/resource-synchronization.md)
