...
Runtime Bootstrapper sits inside a Kyma runtime cluster and acts as a transparent infrastructure adapter. Its external communication partners are:
...
| KIM → Kubernetes API | HTTPS | Outbound – manages webhook deployment; shares resources like pull-secrets, cluster trust bundles etc. |
